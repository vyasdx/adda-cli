...
<p align="center">
  ...
  <img alt="tests 179 passing" src="https://img.shields.io/badge/tests-179%20passing-3b6d11">
...
adda restated ./my-project --rev HEAD          # after a correction: where else is the old wording still stated?
```
