...
## Notes
- Thirteen commands. The test count is not recorded here - CI derives it (`scripts/check_counts.py`); a hand-kept number drifted five times. OKF schema locked at v0.2 (ADR-0005).
